...
const Imageviewer = ({navigation}) => {
    ...
    return (
        <View style={{ height: Dimensions.get('window').height, borderBottomLeftRadius: 24, borderBottomRightRadius: 24, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.24)' }}>
            ...
            <View style={{height:'80%' , width:'100%', flexDirection:'row' , justifyContent:'center' , alignItems:'center' , paddingHorizontal:5 }}>
            ...
            <View style={{ position: 'absolute', bottom: 14, width: '100%', flexDirection: 'row', justifyContent: 'center' }}>
            <LinearGradient colors={['#AA357C', '#E83741']} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} style={{ borderRadius: 9,}}>
                
                <View style={{  borderRadius: 9, flexDirection: 'row', height: 53, width: 170, justifyContent: 'space-around', alignItems: 'center' }}>

                    <Icon name="arrowdown" size={20} color="#fff" />
                    <Text style={{ color: '#fff', fontSize: 18, fontFamily: `${ Ifont }`, width: 100 }}>Download</Text>
